...
class ResourceManagerTest {
     ...
     * над существующим классом, реализуюшая паттерн декоратор, когда мы вызываем метод шпиона, то
     ...
     * [every] и метода [answers] можно подменить реализацию метода существующего класса. Примеры
     ...
     * является [verify]. Для того, чтобы определить сколько раз вызывался метоmockkд(лямбда) (нам в
