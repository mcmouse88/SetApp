...
import com.mcmouse.nav_tabs.models.sqlite.AppSQLiteContract.AccountsBoxesSettingsTable
import com.mcmouse.nav_tabs.models.sqlite.AppSQLiteContract.BoxesTable
...
class SQLiteBoxesRepository(
    ...
    private fun queryBoxes(onlyActive: Boolean, accountId: Long): Cursor {
        return if (onlyActive) {
            ...
            return database.rawQuery(sql, arrayOf(accountId.toString()))
        } else {
            database.rawQuery(
