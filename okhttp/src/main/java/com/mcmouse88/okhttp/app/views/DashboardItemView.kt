package com.mcmouse88.okhttp.app.views
...
import com.mcmouse88.okhttp.databinding.PartDashboardItemBinding
...
class DashboardItemView @JvmOverloads constructor(
    ...
    private fun parseAttributes(attributesSet: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        val defaultTitle = context.getString(R.string.no_title)
